...
background = pygame.image.load('space_invader/bgspace.png')
pygame.display.set_caption("Space Invader")
icon = pygame.image.load('space_invader/ufo.png')
pygame.display.set_icon(icon)

player_img = pygame.image.load('space_invader/p1.png')
...
for _ in range(num_of_enemies):
    enemy_img.append(pygame.image.load('space_invader/eneym.png'))
...
bullet_sound = pygame.mixer.Sound('lasergun.mp3')
